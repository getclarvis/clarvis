...
> **Beta:** `0.0.3-beta` is a prerelease. Interfaces and pre-release state formats may change, and
...
```bash
curl -fsSL https://github.com/getclarvis/clarvis-releases/releases/download/v0.0.3-beta/install.sh | sh
```

Windows PowerShell:

```powershell
irm https://github.com/getclarvis/clarvis-releases/releases/download/v0.0.3-beta/install.ps1 | iex
```
