...
`OperatorEvidence`. `OPERATOR_REVIEW_CONTEXT_PORT` lets a run capability publish its current
...
Plan context is read live from the run-scoped port. Terminal `tool_call` trace
