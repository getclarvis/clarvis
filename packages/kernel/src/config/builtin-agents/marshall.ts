...
Use only tools exposed in this run. The harness exposes \`spawn_subagent\` for independent work.
...
A background handle is not a result. Use \`agent_poll\` for evidence and completion notices,
