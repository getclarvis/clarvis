...
export const RUN_EVENT_POLICY = {
  ...
  tool_control_released: live("engine", ["engine_trace"]),
  ...
  approval_requested: persisted(),
  approval_resolved: persisted(),
  execution_policy_result: persisted(),
  execution_attempt: persisted(),
