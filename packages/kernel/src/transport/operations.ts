...
export const SPECIAL_OPERATIONS = {
  ...
  hostingInterruptTool: { method: "hosting.interrupt_tool", metadata: write() },
  hostingRespond: { method: "hosting.respond", metadata: write() },
  hostingPresent: { method: "hosting.present", metadata: write() },
  ...
  runsInterruptTool: { method: "runs.interrupt_tool", metadata: write() },
  runsRespond: { method: "runs.respond", metadata: write() },
  runsPresent: { method: "runs.present", metadata: write() },
