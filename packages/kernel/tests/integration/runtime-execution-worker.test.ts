...
import { CONTAINER_CORE_CAPABILITY_METHODS } from "../../src/runtime/container-core-policy.ts";

describe("runtime execution worker", () => {
  it("keeps the three private method vocabularies exact and rejects removed feature methods", () => {
    expect(HOST_EXECUTION_METHODS).toEqual([
      "runtime.bootstrap",
      "runtime.start",
      "runtime.steer",
    ...
    expect(GUEST_EXECUTION_METHODS).toEqual([
      "host.model",
      "host.capability",
      "host.event",
      "host.checkpoint",
    ...
    for (const method of ["runtime.hook_mcp", "runtime.mcp_elicit", "runtime.skills"]) {
      expect(
        decodeExecutionFrame({
          type: "request",
          id: 1,
