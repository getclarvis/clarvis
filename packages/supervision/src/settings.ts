 ...
 *
 * The rest are bracketed rather than derived. `max_consecutive_failed_children` is 3 on
...
/** The `agents:` block: per-child buffer bounds, the poll page size, and the ceilings
 * that keep a fan-out from consuming the parent it reports to. */
