...
/**
 * A starter allow list for a Windows host: the read-only and build commands of
 * an ordinary development loop.
 *
 * @remarks
 ...
 * workspace, and every entry still passes through the deny list, the
 * undecidable check and the confinement check first - a match only spares the
 * approval prompt.
 */
