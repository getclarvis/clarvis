...
| [`effect-review.md`](execution/effect-review.md) | Authenticated operator evidence, host effect attestation, revisioned grants, reviewer rollout and receipts | `capability`, `tools`, `kernel`, `loop`, `trace`, `workflows`, `protocol`, `code` |
