...
| [`code-domain-hubs.md`](hosts/code-domain-hubs.md) | The four full-screen domain views (agents, workflows, sessions, memory) and the controller/adapter layering that keeps them thin | `code` |
