...
The full composer image budget is transferable through local-host and SSH stdio.
    ...
    in [stdio-codec.test.ts](../../packages/kernel/tests/contract/stdio-codec.test.ts).
