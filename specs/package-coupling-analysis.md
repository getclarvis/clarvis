...
| `kernel` | host-implementation | `capability`, `loop`, `memory`, `paths`, `plan`, `protocol`, `skills`, `tasks`, `tools`, `trace`, `workflows` | 2 |
...
| `mcp-client` | execution-service | `capability`, `paths` | 1 |
